...
namespace MobileClient {
    class LogicalLocationFinder {
        ...
        public LogicalLocationFinder() {
            ...
            locationList.Add(new LocationPoint("Home", 27.55480, -99.44130, .0003, .0003, .0003, .0003));
            ...
            locationList.Add(new LocationPoint("Department Buidling", 32.5007, -84.9408, .0003, .0004, .0001, .0001));
