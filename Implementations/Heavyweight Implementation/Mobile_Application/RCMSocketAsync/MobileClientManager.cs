...
namespace MobileClient {
    public class MobileClientManager {
        ...
        private RSAUser userCryptoInfo = new RSAUser();
        ...
        public bool setAndroidFilepath(string filepath)
        {
            return rBuilder.setAndroidDirectory(filepath);
        }
        ...
        public async Task RequestResources(string systemFilepath, RSAUser ecdhUser) {
