...
namespace MobileClient
{
    class LogicalLocationFinder
    {
        ...
        public LogicalLocationFinder()
        {
            ...
            //Modified Test Locations (REU)
            locationList.Add(new LocationPoint("Development Office", 40.7484, -73.9856, .0001, .0001, .0004, .0003));
            locationList.Add(new LocationPoint("TestingOffice", 39.7503, -104.9489, .0003, .0004, .0001, .0001));
            locationList.Add(new LocationPoint("DirectorOffice", 34.07473, -118.2398, .0001, .0001, .0003, .0003));
            locationList.Add(new LocationPoint("Department Buidling", 32.5007, -84.9342, .0003, .0004, .0001, .0001));

            //Original Test Locations
            //locationList.Add(new LocationPoint("Development Office", 27.5721, -99.4355, .0001, .0001, .0004, .0003));
            //locationList.Add(new LocationPoint("TestingOffice", 27.5728, -99.4356, .0003, .0004, .0001, .0001));
