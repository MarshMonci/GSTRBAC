...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Mobile_Application.Android.dll" comes first in this list. */
		"Mobile_Application.Android.dll",
		"SerializablePackages.dll",
		"FormsViewGroup.dll",
		"Mobile_Application.dll",
